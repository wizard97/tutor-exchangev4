    ...
    $('.typeahead').typeahead(null,
        {
            ...
            templates: {
                notFound: [
                    ...
                    '<strong>Sorry, we could not find that school. To submit a new school go <a href="{{route('proposals.submitschool')}}">here</a></strong>',
                    '</p>'
                ].join('\n'),
