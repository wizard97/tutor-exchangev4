...
<div class="form-group">
  ...
  <input type="email" name="email" class="input-lg form-control" id="email" placeholder="Email">
</div>
...
<input type="submit" class="col-xs-12 btn btn-primary btn-lg btn-block" value="Change Password">

<a href="/auth/login" type="button" class="col-xs-12 btn btn-default btn-lg btn-block">Back to Login</a>
</form>
</div><!--/col-sm-6-->
</div><!--/row-->
@stop
