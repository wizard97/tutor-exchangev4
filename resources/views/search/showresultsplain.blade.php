...
<div class="table-responsive">
  ...
  <tbody>
    ...
    <td class="vert-align">
      <atarget="_blank" href="{{ route('search.showtutorprofile', ['id' => $tutor->user_id]) }}"><img src="{{ route('profileimage.showsmall', ['id' => $tutor->user_id]) }}" class="img-rounded" height="50" width="50" /></a>
    </td>
    ...
    <td class="vert-align">
      @if($tutor->account_type > 2) <span class="text-success">Professional Tutor</span>
      @else Standard Tutor
      @endif
    </td>
