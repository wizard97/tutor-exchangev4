...
class Tutor extends Model
{
  protected $primaryKey = 'user_id';
    ...
    {
      return $this->belongsToMany('App\Models\Level\Level', 'tutor_levels', 'user_id', 'level_id')->withTimestamps();
    }

    public function music()
    {
      return $this->belongsToMany('App\Models\Music\Music', 'tutor_music', 'tutor_id', 'music_id')->withTimestamps()->withPivot('upto_years', 'years_experiance');
    }

    //middle school classes and below
    public function middle_classes()
    {
      return $this->belongsToMany('App\Models\MiddleClass\MiddleClass', 'tutor_middle_classes', 'tutor_id', 'middle_classes_id')->withTimestamps();
    }

    public function reviews()
    {
      return $this->hasMany('App\Models\Review\Review', 'tutor_id', 'user_id');

    }

    public function schools()
    {
        return $this->belongsToMany('App\Models\School\School', 'tutor_schools', 'tutor_id', 'school_id')->withTimestamps();
    }

    public function contacts()
    {
      return $this->hasMany('App\Models\TutorContact\TutorContact', 'tutor_id', 'user_id');
    }

    public function user_saves()
    {
      return $this->belongsToMany('App\Models\User\User', 'tutor_contacts', 'tutor_id', 'user_id')->withTimestamps()->withPivot('message', 'subject');
    }
